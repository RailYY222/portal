...
class ApplicationViewSet(viewsets.ModelViewSet):
    ...
    # Добавляем queryset для корректной работы router
    ...
    # Добавляем пустой queryset для router (будет переопределён в get_queryset)
...
class ReviewViewSet(viewsets.ModelViewSet):
    ...
    # Добавляем пустой queryset для router
